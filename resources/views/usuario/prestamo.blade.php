...
<div class="row">
	...
	<h3>Prestamos <a href="{{route('usuario.bienvenido')}}"><button class="btn btn-success">Nuevo Prestamo</button></a></h3>	
	</div>
</div>
	    	...
	    	<table class="table table-striped table-bordered table-condensed table-hover">
              ...
              @foreach($bienvenido as $bienvenidos)
	    		<tr>
                    ...
                    <td>
					<a href="#"><i class="glyphicon glyphicon-pencil"></i>Editar</a> 
