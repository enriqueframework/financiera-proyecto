...
<div class="row">
	...
	<h3>Pagos <a href="{{route('pago.excel')}}"><button class="btn btn-success">Descargar</button></a></h3>	
	</div>
</div>
		   ...
		   <br>
	    	<table class="table table-striped table-bordered table-condensed table-hover">
	    		...
	    		<tr>
                    ...
                    <td>{{$pagos->total}}</td>
                    <td>
					<a href="/pago/{{$pagos->idpagos}}/edit"><i class="glyphicon glyphicon-pencil"></i>Update</a>                  
            </td>
	    		</tr>
                @endforeach
				{{$pago->render()}}
