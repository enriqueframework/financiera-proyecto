...
<div class="row">
	...
	<h3>Pagos <a href="{{route('pagos.excel')}}"><button class="btn btn-success">Descargar</button></a></h3>	
	</div>
</div>
		   ...
		   <br>
	    	<table class="table table-striped table-bordered table-condensed table-hover">
	    		...
	    		<tr>
                    ...
                    <td>{{$pagos->total}}</td>
                    <td>
					<a href="/nuevo/{{$pagos->idpagos}}/edit"><i class="glyphicon glyphicon-pencil"></i>Actualizar</a>                  
            </td>
	    		</tr>
                @endforeach
				{{$pago->render()}}
